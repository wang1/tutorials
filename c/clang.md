...
[棋歌教学网实验一中的第8题兑换硬币](../../c-experiment.html#1-p)即为穷举/枚举。
...
我们前面学习的`Fibonacci`数列，以及[棋歌教学网实验一课后练习中的第4题——任意输入一个正整数，倒序输出](../../c-experiment.html#1-p)即为迭代。
...
程序请参见（[棋歌教学网实验四第3题](https://qige.io/c/c-experiment.html#4)）
